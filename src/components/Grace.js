  ...
  return(
    <div className="container">
      ...
      <Row className="home-top-image-row">
        ...
        <h4 className="project-tech"><span className="bold-text">Technology used:</span> React-Native, Viro React, Redux</h4>
      </Row>
      <div className="project-tech bold-center-links">
        <Row className="project-link-space-top">
          <Col sm={6}>
             <a href="" target="_blank" rel="noopener noreferrer">Video Link</a>
          </Col>
           <Col>
      ...
      <Row className="home-top-image-row">
        <Col className="project-center-image">
          <img src={graceGif} alt="TCY shop page"/>
        </Col>
      </Row>
      <Row className="home-top-image-row">
        <Col className="project-center-image">
          <img className="project-image-resize" src={wireframe} alt="TCY shop page"/>
        </Col>
      </Row>
